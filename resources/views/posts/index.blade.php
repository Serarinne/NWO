...
<head>
    ...
    <meta name="description" content="Read the latest news, updates, and articles from the {{ env('APP_NAME') }} team. Discover new Neverness to Everness wallpaper collections, artist spotlights, and community highlights.">
    <meta name="keywords" content="ntewallpapers blog, neverness to everness news, nte updates, wallpaper collections, game art spotlight">
    <meta name="robots" content="index, follow, max-image-preview:large">

    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="News & Articles | {{ env('APP_NAME') }} Blog" />
    <meta property="og:description" content="Read the latest news, updates, and articles from the {{ env('APP_NAME') }} team about Neverness to Everness." />
    ...
    <meta name="twitter:description" content="Read the latest news, updates, and articles from the {{ env('APP_NAME') }} team about Neverness to Everness." />
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "News and articles about Neverness to Everness wallpapers and artists.",
...
<body class="bg-[#0f172a] text-gray-200 font-sans min-h-screen flex flex-col selection:bg-cyan-500 selection:text-white">
    ...
    <main class="flex-grow relative overflow-hidden">
        ...
        <div class="relative bg-gray-900 border-b border-gray-800 py-16 sm:py-24">
            ...
            <div class="absolute inset-0 bg-[url('https://storage.ntewallpapers.com/assets/pattern.svg')] opacity-5"></div>
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                ...
                <p class="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">
                    Stay updated with the latest Neverness to Everness news, wallpaper collections, artist spotlights, and community highlights.
                </p>
            </div>
        </div>
