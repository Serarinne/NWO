...
<head>
    ...
    <meta name="keywords" content="nte wallpapers, {{ $category->name ?? 'review' }}, nte blog category, neverness to everness news">
        ...
        <div class="relative bg-gray-900 border-b border-gray-800 py-12 md:py-16">
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="flex flex-col items-center text-center">
                    <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 mb-4 uppercase tracking-wider">
                        Category Archive
                    </span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                @empty
                    <div class="col-span-full py-20 text-center bg-gray-800/30 rounded-2xl border border-gray-700/50 border-dashed">
                        ...
                        <div class="text-lg font-medium text-white">No articles found</div>
                        <p class="text-gray-400 mt-2">There are no posts in this category yet.</p>
                        <a href="{{ route('posts.index') }}" class="mt-6 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-cyan-600 hover:bg-cyan-700 transition-colors">
                            Back to Blog
                        </a>
                    </div>
                @endforelse
