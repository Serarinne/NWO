        ...
        <div class="relative bg-gray-900 border-b border-gray-800 overflow-hidden">
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
                ...
                <div class="mb-6 flex flex-wrap items-center gap-2 text-xs font-bold text-gray-400 uppercase tracking-widest">
                    <a href="{{ route('wallpapers.index') }}" class="hover:text-cyan-400 transition-colors focus-visible:outline-none">Home</a>
                    ...
                    <div class="flex-grow text-center md:text-left pt-1 w-full md:w-auto">
                        ...
                        @if($wallpapers->total() > 0)
                            <div class="flex justify-center md:justify-start">
                                <a href="{{ route('wallpapers.index') }}" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-gray-800 hover:bg-gray-750 border border-gray-700 hover:border-cyan-500/50 transition-all text-sm font-medium text-gray-300 hover:text-white group">
