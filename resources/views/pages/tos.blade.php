...
<head>
    ...
    <meta name="description" content="Review the Terms of Service for {{ env('APP_NAME') }}. Learn about your rights and responsibilities regarding user accounts, content submission, and copyright on our Neverness to Everness wallpaper platform.">
    <meta name="keywords" content="nte wallpapers, terms of service, tos, user agreement, rules, copyright policy, nte wallpaper terms, neverness to everness rules">
                    ...
                    <section>
                        ...
                        <ul class="space-y-3 pl-2">
                            <li class="flex items-start">
                                ...
                                <span>You are solely responsible for the content you upload, including images and associated metadata (tags, characters, locations, artists).</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-6 h-6 text-cyan-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
