            ...
            <article class="bg-gray-800/50 backdrop-blur-md border border-gray-700/50 rounded-2xl shadow-2xl p-8 md:p-12 relative overflow-hidden">
                ...
                <div class="space-y-8 text-gray-300 leading-relaxed text-lg">
                    <p class="border-b border-gray-700/50 pb-6">
                        Welcome to <strong>{{ env('APP_NAME') }}</strong>. We respect your privacy and are committed to protecting it. This Privacy Policy explains what information we collect, how we use it, and your rights in relation to it regarding our Neverness to Everness wallpaper platform.
                    </p>
                    ...
                    <section>
                        ...
                        <div class="mt-4">
                            <a href="mailto:privacy@ntewallpapers.com" class="inline-flex items-center text-cyan-400 hover:text-white transition-colors bg-gray-900/50 px-6 py-3 rounded-lg border border-cyan-900/30 hover:border-cyan-500/50">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                                </svg>
                                privacy@ntewallpapers.com
                            </a>
                        </div>
                    </section>
                </div>
