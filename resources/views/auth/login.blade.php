...
<head>
    ...
    <meta name="description" content="Sign in to your {{ env('APP_NAME') }} account to save favorite wallpapers, comment, access exclusive content, and enjoy a personalized Neverness to Everness wallpaper experience." />
    <meta name="keywords" content="nte wallpapers, nte wallpaper, neverness to everness wallpaper, login, sign in, game wallpaper account" />

    <meta name="robots" content="index, follow, max-image-preview:large" />

    <meta property="og:locale" content="en_US" />
    <meta property="og:title" content="Login to Your Account" />
    <meta property="og:description" content="Sign in to your {{ env('APP_NAME') }} account to save favorite wallpapers, comment, access exclusive content, and enjoy a personalized Neverness to Everness wallpaper experience." />
    <meta property="og:url" content="{{ route('login.index') }}" />
    <meta property="og:site_name" content="{{ env('APP_NAME') }}" />

    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Login to Your Account" />
    <meta name="twitter:description" content="Sign in to your {{ env('APP_NAME') }} account to save favorite wallpapers, comment, access exclusive content, and enjoy a personalized Neverness to Everness wallpaper experience." />
        ...
        <div class="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-0 bg-gray-800/40 backdrop-blur-xl border border-gray-700/50 rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="p-8 lg:p-12 flex flex-col justify-center relative z-10">
                <div class="mb-10 text-center lg:text-left">
                    ...
                    <p class="text-sm text-gray-400 leading-relaxed">Login to access your account, save your favorite Neverness to Everness wallpapers, and join the community.</p>
                </div>
