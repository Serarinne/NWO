...
<head>
    ...
    <meta name="description" content="Find high-quality Neverness to Everness wallpapers matching your search for '{{ $query }}'. Explore a vast collection of art featuring your favorite Espers and locations.">
    <meta name="robots" content="noindex, follow">

    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Search Results for '{{ $query }}' | {{ env('APP_NAME') }}" />
    <meta property="og:description" content="Find high-quality Neverness to Everness wallpapers matching your search for '{{ $query }}'." />
    <meta property="og:site_name" content="{{ env('APP_NAME') }}" />

    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="Search Results for '{{ $query }}' | {{ env('APP_NAME') }}" />
    <meta name="twitter:description" content="Find high-quality Neverness to Everness wallpapers matching your search for '{{ $query }}'." />
...
<body class="bg-[#0f172a] text-gray-200 font-sans min-h-screen flex flex-col selection:bg-cyan-500 selection:text-white">
    ...
    <main class="flex-grow relative overflow-hidden py-12">
        ...
        {{-- Updated background blur color to match NTE vibes --}}
        <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-purple-900/10 blur-[120px] rounded-full pointer-events-none -z-10"></div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            ...
            <div class="text-center mb-12">
                ...
                <div class="max-w-xl mx-auto mt-8">
                    <form action="{{ route('wallpapers.search') }}" method="GET" class="relative group">
                        {{-- Updated gradient to cyan-purple --}}
            ...
            @else
                <div class="col-span-full py-20 text-center bg-gray-800/30 rounded-2xl border border-gray-700/50 border-dashed">
                    ...
                    <div class="text-lg font-medium text-white">No matches found</div>
