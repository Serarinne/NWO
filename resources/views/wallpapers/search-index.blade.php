...
<head>
    ...
    <meta name="description" content="Search thousands of high-quality Neverness to Everness wallpapers on {{ env('APP_NAME') }}. Find 4K and HD backgrounds of your favorite Espers for your PC or smartphone.">
    <meta name="keywords" content="search, find wallpaper, nte wallpapers, nte wallpaper, neverness to everness, esper wallpaper, 4K wallpaper, HD wallpaper">
    <meta name="robots" content="index, follow">

    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Search NTE Wallpapers | {{ env('APP_NAME') }}" />
    <meta property="og:description" content="Search thousands of high-quality Neverness to Everness wallpapers on {{ env('APP_NAME') }}." />
    <meta property="og:url" content="{{ route('wallpapers.search') }}" />
    <meta property="og:site_name" content="{{ env('APP_NAME') }}" />

    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="Search NTE Wallpapers | {{ env('APP_NAME') }}" />
    <meta name="twitter:description" content="Search thousands of high-quality Neverness to Everness wallpapers on {{ env('APP_NAME') }}." />
...
<body class="bg-[#0f172a] text-gray-200 font-sans min-h-screen flex flex-col selection:bg-cyan-500 selection:text-white">
    ...
    <main class="flex-grow relative flex flex-col items-center overflow-hidden pt-12 pb-20">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none -z-10">
            ...
            <div class="absolute inset-0 bg-[url('https://storage.ntewallpapers.com/assets/pattern.svg')] opacity-[0.03]"></div>
        </div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 w-full max-w-6xl relative z-10">
            ...
            <div class="text-center mb-10">
                ...
                <h1 class="text-4xl md:text-6xl font-extrabold text-white mb-4 tracking-tight">
                    Find Your <span class="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500">Esper</span>
                </h1>
                <p class="text-lg text-gray-400 max-w-lg mx-auto">
                    Search through thousands of high-resolution wallpapers. Characters, locations, artists, or specific tags.
                </p>
            </div>
