...
<head>
    ...
    "itemListElement": [
        ...
        "@@type": "ListItem",
        "position": 2,
        "name": "{{ $wallpaper->characters[0]->name ?? 'NTE Character' }}",
        "item": "{{ isset($wallpaper->characters[0]) ? route('characters.view', ['slug' => $wallpaper->characters[0]]) : route('wallpapers.index') }}"
        },
        {
        "@@type": "ListItem",
        "position": 3,
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <a href="{{ route('tags.view', ['slug' => $tag]) }}" class="bg-gray-700 hover:bg-gray-600 text-sm font-medium px-4 py-1.5 rounded-full transition-colors">{{ $tag->name }}</a>
                        @endforeach
                    </div>
                </div>
                @endif
