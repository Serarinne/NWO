...
<head>
    ...
    <title>NTE Wallpaper Tags & Categories - Neverness to Everness Backgrounds</title>

    <link rel="canonical" href="{{ route('tags.index') }}" />

    <meta name="description"
        content="Explore our extensive NTE wallpaper tags directory. Find the perfect Neverness to Everness wallpapers and 4K backgrounds by categories like outfits, hair colors, and themes (NTE 壁紙).">
    <meta name="keywords"
        content="nte wallpaper tags, nte wallpapers, neverness to everness wallpaper 4k, nte background, wallpaper nte, nte 壁紙, neverness to everness themes, nte anime wallpapers">
    <meta name="robots" content="index, follow, max-image-preview:large">

    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title"
        content="NTE Wallpaper Tags & Categories - Neverness to Everness Backgrounds" />
  ...
  "@@graph": [
    {
      ...
      "name": "NTE Wallpaper Tags - Neverness to Everness Tag Directory",
      "description": "Browse NTE wallpaper tags and explore Neverness to Everness wallpaper categories, themes, and backgrounds.",
      "isPartOf": {
      ...
      "about": [
        {
          "@@type": "Thing",
          "name": "NTE Wallpaper Tags"
        },
        {
          "@@type": "Thing",
          "name": "Neverness to Everness Wallpaper Tags"
        },
        {
          "@@type": "Thing",
...
<body
    ...
    <main class="flex-grow relative overflow-hidden py-12">
        ...
        <div
            class="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-indigo-900/10 blur-[120px] rounded-full pointer-events-none -z-10">
        </div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            ...
            <div class="text-center mb-12">
                <h1
                    class="text-3xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 mb-4">
                    Explore NTE Wallpaper Tags
                </h1>
                <p class="text-gray-400 text-lg mb-8">Browse our comprehensive directory of <strong>NTE wallpaper tags</strong>. Filter your search to find the perfect <strong>Neverness to Everness wallpaper 4K</strong> based on specific themes, styles, outfits, or features—from stylish jackets to unique <strong>NTE backgrounds</strong> with animal ears.</p>

                <div class="max-w-xl mx-auto">
                    <form action="{{ route('tags.index') }}" method="GET" class="relative group">
                        <div
                            class="absolute -inset-0.5 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg blur opacity-30 group-hover:opacity-70 transition duration-200">
                        </div>
                        <div class="relative flex items-center bg-gray-900 rounded-lg">
                            ...
                            <input type="text" name="query" value="{{ request('query') }}"
                                ...
                                placeholder="Search tags (e.g. Urban, Neon, Cybernetic)..." required>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
                ...
                @forelse($tags as $tag)
                    <div
                        class="group relative rounded-xl overflow-hidden bg-gray-800 shadow-md hover:shadow-2xl hover:shadow-cyan-500/10 transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <div
                        ...
                        @if (request('query'))
                            <a href="{{ route('tags.index') }}"
                                class="mt-4 inline-block text-cyan-400 hover:text-cyan-300 hover:underline">View all
                                tags</a>
                        @endif
                    </div>
                @endforelse
