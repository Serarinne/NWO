        ...
        <div class="relative bg-gray-900 border-b border-gray-800 overflow-hidden">
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-10 relative z-10">
                ...
                <div class="flex items-center gap-2 text-sm text-gray-400 mb-8 font-medium">
                    <a href="{{ route('wallpapers.index') }}" class="hover:text-cyan-400 transition-colors">Home</a>
                    <span>&bull;</span>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-10 max-w-5xl">
            ...
            <form action="{{ route('settings.update') }}" method="POST" class="w-full">
                ...
                <div class="pt-6 border-t border-gray-800 flex flex-col-reverse sm:flex-row items-center justify-end gap-4">
                    <a href="{{ route('wallpapers.index') }}" class="w-full sm:w-auto px-6 py-3 text-sm font-medium text-gray-400 hover:text-white bg-transparent hover:bg-gray-800 rounded-lg transition-colors text-center focus:outline-none focus:ring-2 focus:ring-gray-600">
                        Cancel
                    </a>
