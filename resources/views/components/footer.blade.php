<footer class="bg-gray-900 border-t border-gray-800 pt-12 pb-24 lg:pb-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row justify-between items-center gap-8">
            
            <div class="flex flex-col items-center md:items-start text-center md:text-left space-y-2">
                <a href="{{ route('wallpapers.index') }}" class="flex items-center gap-2 group mb-1">
                    ...
                    <span class="text-lg font-bold text-gray-200 group-hover:text-white transition-colors">{{ env('APP_NAME') }}</span>
                </a>
            ...
            <div class="flex flex-wrap justify-center gap-x-8 gap-y-4">
                <a href="{{ route('about') }}" class="text-sm font-medium text-gray-400 hover:text-cyan-400 transition-colors">
                    About Us
                </a>
                <a href="{{ route('contact') }}" class="text-sm font-medium text-gray-400 hover:text-cyan-400 transition-colors">
                    Contact
                </a>
                <a href="{{ route('privacy') }}" class="text-sm font-medium text-gray-400 hover:text-cyan-400 transition-colors">
                    Privacy Policy
                </a>
                <a href="{{ route('tos') }}" class="text-sm font-medium text-gray-400 hover:text-cyan-400 transition-colors">
                    Terms of Service
                </a>
            </div>
