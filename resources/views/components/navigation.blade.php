...
<nav class="hidden lg:flex fixed top-5 left-0 right-0 z-50 justify-center transition-all duration-300">
    <div class="w-full max-w-7xl mx-4 bg-gray-900/80 backdrop-blur-xl border border-gray-700/50 rounded-2xl shadow-2xl shadow-black/50 px-4 py-3 flex items-center justify-between ring-1 ring-white/10">
        ...
        <div class="flex items-center gap-6 xl:gap-8">
            <a href="{{ route('wallpapers.index') }}" class="group flex items-center gap-2">
            ...
            <div class="flex items-center bg-gray-800/50 rounded-full p-1 border border-gray-700/50 relative overflow-x-auto no-scrollbar">
                ...
                <a href="{{ route('wallpapers.index') }}" class="{{ request()->routeIs('home') ? 'bg-gray-700 text-white shadow-sm' : 'text-gray-400 hover:text-white hover:bg-gray-700/50' }} px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2 whitespace-nowrap">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                    Home
                </a>

                <a href="{{ route('characters.index') }}" class="{{ request()->routeIs('characters.*') ? 'bg-gray-700 text-white shadow-sm' : 'text-gray-400 hover:text-white hover:bg-gray-700/50' }} px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2 whitespace-nowrap">
                ...
                <a href="{{ route('tags.index') }}" class="{{ request()->routeIs('tags.*') ? 'bg-gray-700 text-white shadow-sm' : 'text-gray-400 hover:text-white hover:bg-gray-700/50' }} px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2 whitespace-nowrap">
                ...
                <a href="{{ route('posts.index') }}" class="{{ request()->routeIs('posts.*') ? 'bg-gray-700 text-white shadow-sm' : 'text-gray-400 hover:text-white hover:bg-gray-700/50' }} px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2 whitespace-nowrap">
                    <svg class="w-3.5 h-3.5 {{ request()->routeIs('posts.*') ? 'text-white' : 'text-blue-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" /></svg>
                    Articles
                </a>

                {{-- Tambahan Menu Redeem Codes --}}
                <a href="{{ route('codes.index') }}" class="{{ request()->routeIs('codes.*') ? 'bg-gray-700 text-white shadow-sm' : 'text-gray-400 hover:text-white hover:bg-gray-700/50' }} px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2 whitespace-nowrap">
                    <svg class="w-3.5 h-3.5 {{ request()->routeIs('codes.*') ? 'text-white' : 'text-yellow-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7"></path></svg>
                    Codes
                </a>
            </div>
        </div>
...
<div class="lg:hidden fixed bottom-0 left-0 right-0 bg-gray-900 border-t border-gray-800 z-50 pb-safe">
    <div class="flex items-center justify-around h-16">
        ...
        <a href="{{ route('wallpapers.index') }}" class="flex flex-col items-center justify-center w-full h-full space-y-1 {{ request()->routeIs('home') ? 'text-cyan-400' : 'text-gray-500 hover:text-gray-300' }}">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
            <span class="text-[10px] font-medium">Home</span>
        </a>

        <a href="{{ route('wallpapers.search') }}" class="flex flex-col items-center justify-center w-full h-full space-y-1 {{ request()->routeIs('search.*') ? 'text-cyan-400' : 'text-gray-500 hover:text-gray-300' }}">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
            <span class="text-[10px] font-medium">Search</span>
        </a>

        @auth
            <a href="{{ route('favorites.index') }}" class="flex flex-col items-center justify-center w-full h-full space-y-1 {{ request()->routeIs('my.*') ? 'text-cyan-400' : 'text-gray-500 hover:text-gray-300' }}">
                @if(Auth::user()->avatar)
        ...
        @else
            <a href="{{ route('login.index') }}" class="flex flex-col items-center justify-center w-full h-full space-y-1 text-gray-500 hover:text-gray-300">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"></path></svg>
                <span class="text-[10px] font-medium">Login</span>
            </a>
        @endauth

        <button onclick="document.getElementById('mobile-menu-drawer').classList.remove('translate-y-full')" class="flex flex-col items-center justify-center w-full h-full space-y-1 text-gray-500 hover:text-gray-300 focus:outline-none">
    ...
    <div class="absolute bottom-0 left-0 right-0 bg-gray-900 rounded-t-2xl border-t border-gray-800 p-6 pb-24 shadow-2xl overflow-y-auto max-h-[80vh]">
        ...
        <div class="grid grid-cols-2 gap-4 mb-6">
            <a href="{{ route('characters.index') }}" class="flex flex-col items-center gap-2 p-3 bg-gray-800 rounded-xl hover:bg-gray-700 border border-gray-800 hover:border-pink-500/30 transition-colors">
                ...
                <span class="{{ request()->routeIs('characters.*') ? 'bg-gray-700 text-white shadow-sm' : 'text-gray-400 hover:text-white hover:bg-gray-700/50' }} px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2 whitespace-nowrap">Characters</span>
            </a>
            ...
            <a href="{{ route('posts.index') }}" class="flex flex-col items-center gap-2 p-3 bg-gray-800 rounded-xl hover:bg-gray-700 border border-gray-800 hover:border-blue-500/30 transition-colors">
                ...
                <span class="{{ request()->routeIs('posts.*') ? 'bg-gray-700 text-white shadow-sm' : 'text-gray-400 hover:text-white hover:bg-gray-700/50' }} px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2 whitespace-nowrap">Articles</span>
            </a>
            ...
            <a href="{{ route('tags.index') }}" class="flex flex-col items-center gap-2 p-3 bg-gray-800 rounded-xl hover:bg-gray-700 border border-gray-800 hover:border-green-500/30 transition-colors">
                ...
                <span class="{{ request()->routeIs('tags.*') ? 'bg-gray-700 text-white shadow-sm' : 'text-gray-400 hover:text-white hover:bg-gray-700/50' }} px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2 whitespace-nowrap">Tags</span>
            </a>

            {{-- Tambahan Menu Redeem Codes di Mobile Drawer --}}
            <a href="{{ route('codes.index') }}" class="flex flex-col items-center gap-2 p-3 bg-gray-800 rounded-xl hover:bg-gray-700 border border-gray-800 hover:border-yellow-500/30 transition-colors">
                ...
                <span class="{{ request()->routeIs('codes.*') ? 'bg-gray-700 text-white shadow-sm' : 'text-gray-400 hover:text-white hover:bg-gray-700/50' }} px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2 whitespace-nowrap">Codes</span>
            </a>
        </div>
