    ...
    <div class="w-full max-w-7xl mx-4 bg-gray-900/80 backdrop-blur-xl border border-gray-700/50 rounded-2xl shadow-2xl shadow-black/50 px-4 py-3 flex items-center justify-between ring-1 ring-white/10">
        ...
        <div class="flex items-center gap-6 xl:gap-8">
            ...
            <div class="flex items-center bg-gray-800/50 rounded-full p-1 border border-gray-700/50 relative overflow-x-auto no-scrollbar">
                ...
                <a href="{{ route('wallpapers.index') }}" class="{{ request()->routeIs('wallpapers.index') ? 'bg-gray-700 text-white shadow-sm' : 'text-gray-200 hover:text-white hover:bg-gray-700/50' }} px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2 whitespace-nowrap">
                ...
                <a href="{{ route('codes.index') }}" class="{{ request()->routeIs('codes.*') ? 'bg-gray-700 text-white shadow-sm' : 'text-gray-200 hover:text-white hover:bg-gray-700/50' }} px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2 whitespace-nowrap">
...
<div class="lg:hidden fixed bottom-0 left-0 right-0 bg-gray-900 border-t border-gray-800 z-50 pb-safe">
    <div class="flex items-center justify-around h-16">
        ...
        <a href="{{ route('wallpapers.index') }}" class="flex flex-col items-center justify-center w-full h-full space-y-1 {{ request()->routeIs('wallpapers.index') ? 'bg-gray-700 text-white shadow-sm' : 'text-gray-200 hover:text-white hover:bg-gray-700/50' }}">
    ...
    <div class="absolute bottom-0 left-0 right-0 bg-gray-900 rounded-t-2xl border-t border-gray-800 p-6 pb-24 shadow-2xl overflow-y-auto max-h-[80vh]">
        ...
        <div class="grid grid-cols-2 gap-4 mb-6">
            ...
            <a href="{{ route('posts.index') }}" class="flex flex-col items-center gap-2 p-3 bg-gray-800 rounded-xl hover:bg-gray-700 border border-gray-800 hover:border-blue-500/30 transition-colors">
                ...
                <span class="{{ request()->routeIs('posts.*') ? 'bg-gray-700 text-white shadow-sm' : 'text-gray-200 hover:text-white hover:bg-gray-700/50' }} px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2 whitespace-nowrap">Articles</span>
            </a>
            ...
            <a href="{{ route('codes.index') }}" class="flex flex-col items-center gap-2 p-3 bg-gray-800 rounded-xl hover:bg-gray-700 border border-gray-800 hover:border-yellow-500/30 transition-colors">
                ...
                <span class="{{ request()->routeIs('codes.*') ? 'bg-gray-700 text-white shadow-sm' : 'text-gray-200 hover:text-white hover:bg-gray-700/50' }} px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all flex items-center gap-2 whitespace-nowrap">Codes</span>
            </a>
        </div>
