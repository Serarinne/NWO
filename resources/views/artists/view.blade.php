...
<head>
    ...
    <meta name="description" content="Explore a collection of high-quality Neverness to Everness wallpapers created by {{ $artist->name }}. Browse {{ $artist->wallpapers_count }} unique works on {{ env('APP_NAME') }}.">
    ...
    {{-- Assuming you have these accessors, otherwise use $artist->image['jpg'] --}}
