...
<head>
    ...
    <meta name="description" content="Discover a comprehensive gallery of talented Neverness to Everness artists and creators. Browse through our complete list to find your favorite NTE artworks.">
    <meta name="keywords" content="nte wallpapers, nte artists, neverness to everness creators, wallpaper creators, pixiv artists, game art gallery">
    ...
    <meta property="og:description" content="Discover a comprehensive gallery of talented Neverness to Everness artists and creators." />
    ...
    <script type="application/ld+json">
    {
        ...
        "breadcrumb": {
            "@@type": "BreadcrumbList",
            "itemListElement": [{
                "@@type": "ListItem", "position": 1, "name": "Home", "item": "{{ route('wallpapers.index') }}"
            }, {
        ...
        <div class="relative bg-gray-900 pt-16 pb-12 sm:pt-24 sm:pb-16 border-b border-gray-800">
             ...
             <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                ...
                <p class="text-gray-400 max-w-xl mx-auto mb-8">
                    Explore our curated list of talented illustrators capturing the urban open-world of Neverness to Everness. Click on an artist to view their complete wallpaper collection.
                </p>
            </div>
        </div>
